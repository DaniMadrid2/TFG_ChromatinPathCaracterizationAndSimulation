...
var _Funcion2D_instances, _Funcion2D_ensure_on_View;
...
export class Funcion extends GameObject {
    ...
    tick(dt) {
        ...
        if (this.todraw)
            return;
        this.drawingtime += dt !== null && dt !== void 0 ? dt : 0;
    ...
    draw(ctx) {
        ...
        (_a = this.onStart) === null || _a === void 0 ? void 0 : _a.call(this, lasty, ctx);
        let w = (_b = this.txtW) !== null && _b !== void 0 ? _b : 5;
        ctx.lineWidth = w;
        ctx.strokeStyle = (_c = this.color) !== null && _c !== void 0 ? _c : "black";
        let offx = 0, offy = 0;
        ctx.beginPath();
        let p = { x: (this.sx), y: this.eval(this.sx) };
        let laspp = p;
        let toMove = false;
        ctx.moveTo(((_d = p === null || p === void 0 ? void 0 : p.x) !== null && _d !== void 0 ? _d : 0) * this.scalex + this.offx, ((_e = p === null || p === void 0 ? void 0 : p.y) !== null && _e !== void 0 ? _e : 0) * this.scaley + this.offy);
        for (let index = this.sx / this.scalex; index <= (this.ex) / this.scalex + this.dx; index += this.dx) {
            p = { x: (index), y: this.eval(index) };
            let px = (_f = p === null || p === void 0 ? void 0 : p.x) !== null && _f !== void 0 ? _f : 0 + offx, py = (_g = p === null || p === void 0 ? void 0 : p.y) !== null && _g !== void 0 ? _g : 0 + offy;
            ...
            if ((Math.hypot(dx, dy) > this.maxdis && this.maxdis > 0) || !((_h = this === null || this === void 0 ? void 0 : this.extraDetect) === null || _h === void 0 ? void 0 : _h.call(this, dx, dy))) {
                if (!toMove) {
        ...
        if (!toMove)
            ctx.stroke();
        this.lasty = lasty;
        (_j = this.onEnd) === null || _j === void 0 ? void 0 : _j.call(this, lasty, ctx);
    }
    eval(x) {
...
export class ArrayFuncion extends Funcion {
    constructor() {
        ...
        this.saveSX = 0;
        this.saveEX = -1;
        this.storage = new Float32Array(0);
    }
    eval(x) {
...
export class Funcion2D extends Funcion {
    ...
    draw(ctx) {
        ...
        if (!this.drawEvrytime && !this.todraw && this.drawtime > 0)
            return;
        this.todraw = false;
        let w = (_a = this.txtW) !== null && _a !== void 0 ? _a : 5;
        ctx.lineWidth = ~~(w);
        ctx.strokeStyle = (_b = this.color) !== null && _b !== void 0 ? _b : "black";
        let offx = 0, offy = 0;
        ctx.beginPath();
        ...
        let laspp = p;
        let laspp2 = laspp;
        let tp = __classPrivateFieldGet(this, _Funcion2D_instances, "m", _Funcion2D_ensure_on_View).call(this, p.x, p.y, laspp.x, laspp.y);
        p.x = tp.x;
        p.y = tp.y;
        let toMove = false;
        ctx.moveTo(((_d = (_c = p === null || p === void 0 ? void 0 : p.x) !== null && _c !== void 0 ? _c : p === null || p === void 0 ? void 0 : p[0]) !== null && _d !== void 0 ? _d : 0) + this.offx, ((_f = (_e = p === null || p === void 0 ? void 0 : p.y) !== null && _e !== void 0 ? _e : p === null || p === void 0 ? void 0 : p[1]) !== null && _f !== void 0 ? _f : 0) + this.offy);
        for (let index = this.sx; index <= this.ex; index += this.dx) {
            p = this.eval(index);
            let px = (_h = (_g = p === null || p === void 0 ? void 0 : p.x) !== null && _g !== void 0 ? _g : p === null || p === void 0 ? void 0 : p[0]) !== null && _h !== void 0 ? _h : 0 + offx, py = (_k = (_j = p === null || p === void 0 ? void 0 : p.y) !== null && _j !== void 0 ? _j : p === null || p === void 0 ? void 0 : p[1]) !== null && _k !== void 0 ? _k : 0 + offy;
            laspp2 = { x: px, y: py };
            tp = __classPrivateFieldGet(this, _Funcion2D_instances, "m", _Funcion2D_ensure_on_View).call(this, px, py, laspp.x + offx, laspp.y + offy);
            p.x = tp.x - offx;
            p.y = tp.y - offy;
            px = tp.x;
            py = tp.y;
            ...
            if ((Math.hypot(dx, dy) > this.maxdis && this.maxdis > 0) || !((_l = this === null || this === void 0 ? void 0 : this.extraDetect) === null || _l === void 0 ? void 0 : _l.call(this, dx, dy))) {
                if (!toMove) {
...
_Funcion2D_instances = new WeakSet(), _Funcion2D_ensure_on_View = function _Funcion2D_ensure_on_View(px, py, lpx, lpy) {
    let p = { x: px, y: py };
...
Axis.globalAxis = new Axis(W / 2, H / 2);
var axisCols = {
...
export class Axis2D extends GameObject {
    constructor(center, mat, v2) {
        ...
        this.unitSize = 30;
        this.mat = Matrix2D.fromValues([[1, 0], [0, 1]]);
        this.listeners = [];
    ...
    setAxisProps(axisprops) {
        this.axisprops = Object.assign({}, axisprops);
        return this;
    }
    get center() {
    ...
    updatedV1() {
        ...
        ;
        (_a = this.updateListeners) === null || _a === void 0 ? void 0 : _a.call(this);
    }
    updatedV2() {
        var _a;
        if (!!this.v2) {
    ...
    remove(v) {
        let i = this.listeners.map(v => v === null || v === void 0 ? void 0 : v[0]).indexOf(v);
        if (i !== -1) {
...
export class MatrixObject extends GameObject {
    ...
    draw(ctx) {
        ...
        for (let i = 0; i < this.arr.length; i++) {
            let hs = ((_b = (_a = this.arr) === null || _a === void 0 ? void 0 : _a[i]) === null || _b === void 0 ? void 0 : _b.length) || 0;
            for (let j = 0; j < this.arr[i].length; j++) {
                ctx.txt((((_d = (_c = this.arr) === null || _c === void 0 ? void 0 : _c[i]) === null || _d === void 0 ? void 0 : _d[j]) || "0"), this.x + this.w / 7 - this.w * (1.6 / hs) * Math.floor(-j + 1.5), this.y - this.h * (1.6 / ws) * Math.floor(-i + 1.5) + offy, this.getColor(i, j, ws, hs), "40px Arial");
            }
        }
    }
    getColor(i, j, ws, hs) {
    ...
    dim() {
        var _a, _b, _c;
        return Math.min(this.arr.length, ((_c = (_b = (_a = this.arr) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.length) !== null && _c !== void 0 ? _c : 10000));
    }
    multiply(mat) {
        if (mat.dim() === this.dim()) {
            let dim = mat.dim();
    ...
    toText(pre = "", end = "") {
        ...
        for (let i = 0; i < ((_b = (_a = this.arr) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.length) || 0; i++) {
            ...
            if (i !== ((_c = this.arr) === null || _c === void 0 ? void 0 : _c[0].length) - 1) {
                txt += " \\\\ ";
            }
        }
...
export class Funcion3D extends Funcion2D {
    ...
    eval(x) {
        ...
        (_a = res.z) !== null && _a !== void 0 ? _a : (res.z = 1);
        if (this.appply)
            res = (_c = (_b = this.applyRots3d) === null || _b === void 0 ? void 0 : _b.call(this, res, this.x, this.y, this.z)) !== null && _c !== void 0 ? _c : res;
        res.y += this.y;
        res.x += this.x;
        res.z += ((_d = this.z) !== null && _d !== void 0 ? _d : 0) + this.FOV;
        if (res.z === 0)
            res.z = 0.001;
        this.lastz = res.z;
...
export class Waiter {
    ...
    addSingle(changer) {
        ...
        if (changer === null || changer === void 0 ? void 0 : changer.added)
            (_a = changer === null || changer === void 0 ? void 0 : changer.added) === null || _a === void 0 ? void 0 : _a.call(changer, this.changers.length - 1, this);
    }
    addHandler(...handlers) {
    ...
    addSingleHandler(handler) {
        ...
        if (handler === null || handler === void 0 ? void 0 : handler.added)
            (_a = handler === null || handler === void 0 ? void 0 : handler.added) === null || _a === void 0 ? void 0 : _a.call(handler, this.handlers.length - 1, this);
    }
    next(dt) {
        var _a, _b;
        ...
        this.time = 0;
        (_b = (_a = this.current) === null || _a === void 0 ? void 0 : _a.change) === null || _b === void 0 ? void 0 : _b.call(_a, dt, this.time, this.handlers);
    ...
    logChain(split = 5) {
        ...
        for (let i = 0; i < this.changers.length; i++) {
            if ((_a = this.changers[i]) === null || _a === void 0 ? void 0 : _a.name)
    ...
    callChanger(changer, dt) {
        var _a, _b;
        if (changer === null || changer === void 0 ? void 0 : changer.tick)
            return ((_b = (_a = changer).tick) === null || _b === void 0 ? void 0 : _b.call(_a, dt, this.time, this.handlers), undefined);
        if (typeof changer == "function")
            return changer === null || changer === void 0 ? void 0 : changer(dt, this);
    }
    label(label = "") {
        this.addSingle({
            added: (i) => {
    ...
    static goLabel(label = "", w) {
        return (dt, waiter) => {
            (w !== null && w !== void 0 ? w : waiter).currenti = (w !== null && w !== void 0 ? w : waiter).labels.get(label);
        };
    }
    ...
    waitEvent(name, cb, anytime = false) {
        ...
        this.addEventListener(name, (val) => {
            ...
            if (received && !anytime)
                return;
            received = true;
            cb === null || cb === void 0 ? void 0 : cb(val);
        });
        let fx = {
...
Waiter.eventListeners = [];
Waiter.emitEvent = (name, val = "") => {
    var _a;
    let listeners = Waiter.eventListeners[name];
    if (listeners)
        for (let i = 0; i < listeners.length; i++) {
            (_a = listeners[i]) === null || _a === void 0 ? void 0 : _a.call(listeners, val);
        }
};
export class WaiterBinder {
    ...
    calculateLast(i) {
        ...
        switch (this.type) {
            ...
            case WaiterBinder.Name:
                this.last = ((_a = waiter.current) === null || _a === void 0 ? void 0 : _a.name) || "func";
                break;
    ...
    isAsLast(i) {
        ...
        switch (this.type) {
            ...
            case WaiterBinder.Name:
                return (((_a = waiter.current) === null || _a === void 0 ? void 0 : _a.name) || "func") == this.last;
            case WaiterBinder.Normal:
            default:
                return true;
        }
...
WaiterBinder.Normal = 0;
WaiterBinder.Index = 1;
WaiterBinder.Class = 2;
WaiterBinder.Name = 3;
WaiterBinder.TotalIndex = 4;
export class Changer {
    constructor(object = null, cb = null) {
        this.object = object;
        this.cb = cb;
        this.name = "Change this name to describe action";
        this.done = false;
        this.startDone = false;
        this.get = () => this.object;
        this.then = () => { var _a; (_a = this === null || this === void 0 ? void 0 : this.cb) === null || _a === void 0 ? void 0 : _a.call(this); };
    }
...
export class LogerW extends Changer {
    ...
    tick(...args) {
        ...
        if (typeof this.txt == "function")
            console.log((_a = this.txt) === null || _a === void 0 ? void 0 : _a.call(this, ...args));
        else
...
(() => {
    Easer.EaseInOut = new EaserInOut();
})();
export class PosChanger extends Changer {
    constructor(obj, toPos = obj, speed = 1, cb) {
        ...
        this.minTime = 0;
        this.maxTime = 1;
        this.easer = Easer.Linear;
        if (!((_a = this.object) === null || _a === void 0 ? void 0 : _a._)) {
    ...
    ease(t) {
        ...
        if (!(this.easer instanceof Easer) && typeof this.easer == "function")
            return (_a = this.easer) === null || _a === void 0 ? void 0 : _a.call(this, t);
        return (_c = (_b = this.easer) === null || _b === void 0 ? void 0 : _b.ease) === null || _c === void 0 ? void 0 : _c.call(_b, t);
    }
    tick(dt, time) {
        if (this.done)
            return;
...
export class PosChangerByRotation extends PosChanger {
    constructor() {
        super(...arguments);
        this.direction = PosChangerByRotation.Closest;
    }
    getObjPos(dt, time, firstPos, toPos, t) {
...
PosChangerByRotation.Closest = 0;
PosChangerByRotation.ClockWise = -1;
PosChangerByRotation.CounterClockWise = 1;
PosChangerByRotation.CW = -1;
PosChangerByRotation.CCW = 1;
export class NearPosChanger extends PosChanger {
    constructor(obj, toPos = obj, speed = 100, cb) {
        super(obj, cb);
        this.toPos = toPos;
        this.speed = speed;
        this.name = "Near Pos Set";
        this.getDirection = (x, y, fx, fy) => {
...
export class ChangerArr extends Changer {
    ...
    change(dt, time, handlers = [], ...args) {
        this.done = false;
        if (handlers.filter)
            handlers = handlers.filter(h => !!h && (h === null || h === void 0 ? void 0 : h.get) !== undefined);
    ...
    callChange(dt, time, handlers, ...args) {
        ...
        if (typeof this.handle == "function")
            (_a = this.handle) === null || _a === void 0 ? void 0 : _a.call(this, dt, time, handlers, this.changers);
        for (let i = 0; i < this.changers.length; i++) {
            if (typeof this.changers[i] === "function") {
                (_c = (_b = this.changers)[i]) === null || _c === void 0 ? void 0 : _c.call(_b, true, dt, this.getTime(i, time), handlers, ...args);
            }
            (_e = (_d = this.changers[i]) === null || _d === void 0 ? void 0 : _d.change) === null || _e === void 0 ? void 0 : _e.call(_d, dt, this.getTime(i, time), handlers, ...args);
        }
    }
    getTime(i, time) {
        var _a;
        return (_a = this.times[i]) !== null && _a !== void 0 ? _a : time;
    }
    tick(dt, time, ...args) {
        ...
        for (let i = 0; i < this.changers.length; i++) {
            if (this.repeat) {
                (_a = (_j = this.times)[i]) !== null && _a !== void 0 ? _a : (_j[i] = 0);
                this.times[i] += dt;
            }
            if (typeof this.changers[i] === "function") {
                (_c = (_b = this.changers)[i]) === null || _c === void 0 ? void 0 : _c.call(_b, false, dt, this.getTime(i, time));
            }
            else if (this.changers[i].done === false)
                (_e = (_d = this.changers[i]) === null || _d === void 0 ? void 0 : _d.tick) === null || _e === void 0 ? void 0 : _e.call(_d, dt, this.getTime(i, time));
                ...
                this.times[i] = 0;
                if (typeof this.handle == "function")
                    (_f = this.handle) === null || _f === void 0 ? void 0 : _f.call(this, dt, this.getTime(i, time), this.handlers, this.changers);
                (_h = (_g = this.changers[i]) === null || _g === void 0 ? void 0 : _g.change) === null || _h === void 0 ? void 0 : _h.call(_g, dt, this.getTime(i, time), this.handlers, ...args);
            }
        }
