...
export class AxisGridProgram extends WebProgram {
    ...
    addGrid(plane, vertices) {
        ...
        const sizeX = (_b = (_a = this.axisLengths) === null || _a === void 0 ? void 0 : _a.x) !== null && _b !== void 0 ? _b : 1.0;
        const sizeY = (_d = (_c = this.axisLengths) === null || _c === void 0 ? void 0 : _c.y) !== null && _d !== void 0 ? _d : 1.0;
        const sizeZ = (_f = (_e = this.axisLengths) === null || _e === void 0 ? void 0 : _e.z) !== null && _f !== void 0 ? _f : 1.0;
...
export class Axis3DGroup {
    ...
    initUniforms() {
        var _a, _b;
        this.lines.use();
        (_b = (_a = this.lines).initUniforms) === null || _b === void 0 ? void 0 : _b.call(_a);
...
export class MeshFillerProgram extends WebProgram {
    ...
    draw() {
        ...
        if (!tex)
            return;
        const tw = (_a = tex.w) !== null && _a !== void 0 ? _a : this.w;
        const th = (_b = tex.h) !== null && _b !== void 0 ? _b : this.h;
