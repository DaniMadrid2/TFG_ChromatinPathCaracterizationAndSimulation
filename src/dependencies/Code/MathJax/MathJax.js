...
function parseColor(color) {
    ...
    if (/^#([A-Fa-f0-9]{3}){1,2}$/.test(rgba)) {
        return Object.assign({}, hexToRgb(rgba));
    }
...
export class MathJaxLoader {
    ...
    static loadEquation(eq, color, width = { w: 100, h: 100 }, filterColor) {
        ...
        (width === null || width === void 0 ? void 0 : width.w) && (img.width = width === null || width === void 0 ? void 0 : width.w);
        (width === null || width === void 0 ? void 0 : width.h) && (img.height = width === null || width === void 0 ? void 0 : width.h);
        color !== null && color !== void 0 ? color : (color = { r: 0, g: 0, b: 0 });
        (_a = color.r) !== null && _a !== void 0 ? _a : (color.r = 0);
        (_b = color.g) !== null && _b !== void 0 ? _b : (color.g = 0);
        (_c = color.b) !== null && _c !== void 0 ? _c : (color.b = 0);
        (_d = width.w) !== null && _d !== void 0 ? _d : (width.w = 200);
        (_e = width.h) !== null && _e !== void 0 ? _e : (width.h = 200);
        img.onload = () => {
            if (once) {
                once = false;
                if (filterColor) {
    ...
    static filterColorExample(img, color, width) {
        ...
        const canvasWidth = (width === null || width === void 0 ? void 0 : width.w) || img.width;
        const canvasHeight = (width === null || width === void 0 ? void 0 : width.h) || img.height;
        ...
        const processGroup = (group, accumulatedTransform) => {
            ...
            uses.forEach(use => {
                ...
                if (use.parentElement === group ||
                    ...
                    const href = (_a = use.getAttribute("xlink:href")) === null || _a === void 0 ? void 0 : _a.substring(1);
            ...
            Array.from(childGroups).forEach(childGroup => {
                if (childGroup.tagName == "use")
                    return;
                processGroup(childGroup, Object.assign({}, accumulatedTransform));
            });
        };
    ...
    static getTransformMatrix(el) {
        ...
        while (el && el.nodeName !== 'svg') {
            ...
            if (transform.length > 0) {
                matrix = (_b = (_a = transform.consolidate()) === null || _a === void 0 ? void 0 : _a.matrix.multiply(matrix)) !== null && _b !== void 0 ? _b : matrix;
            }
            el = el.parentElement;
        }
        return matrix;
    ...
    static drawPathsOnCanvas(paths, canvas, color = { r: 0, g: 0, b: 0 }, size = 1, offset = { x: 0, y: 0, sx: 1, sy: 1 }, time = 0) {
        ...
        if (!context)
            return;
        context.fillStyle = `rgb(${(_a = color.r) !== null && _a !== void 0 ? _a : 0}, ${(_b = color.g) !== null && _b !== void 0 ? _b : 0}, ${(_c = color.b) !== null && _c !== void 0 ? _c : 0})`;
        context.strokeStyle = `rgb(${(_d = color.r) !== null && _d !== void 0 ? _d : 0}, ${(_e = color.g) !== null && _e !== void 0 ? _e : 0}, ${(_f = color.b) !== null && _f !== void 0 ? _f : 0})`;
        context.lineWidth = 2;
        let scale = 1 / 15 * size;
        let dx = 50;
        let dy = 200;
