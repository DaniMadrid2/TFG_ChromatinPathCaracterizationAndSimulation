export class ObjList {
    ...
    set(...vals) {
        if ((vals === null || vals === void 0 ? void 0 : vals[0]) instanceof ObjList)
...
export class Vector extends ObjList {
    ...
    equals(v, forced = false) {
        ...
        if (forced && v.values.length !== (v === null || v === void 0 ? void 0 : v.values.length))
            return false;
        for (let i = 0; i < Math.min(this.values.length, (_a = v === null || v === void 0 ? void 0 : v.values) === null || _a === void 0 ? void 0 : _a.length); i++) {
...
Vector2D.Identity = new Vector2D(1, 1);
...
Vector3D.Identity = new Vector3D(1, 1, 1);
...
export class MatrixNM {
    ...
    static toLaTex(mat, pre = "", end = "", brtype = 0) {
        ...
        for (let i = 0; i < ((_b = (_a = mat.vecs) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.values.length) || 0; i++) {
            ...
            if (i !== ((_d = (_c = mat.vecs) === null || _c === void 0 ? void 0 : _c[0]) === null || _d === void 0 ? void 0 : _d.values.length) - 1) {
                txt += " \\\\ ";
            }
        }
...
export class Matrix2D extends MatrixNN {
    ...
    equals(m) {
        var _a, _b;
        return this.vecs[0].equals((_a = m === null || m === void 0 ? void 0 : m.vecs) === null || _a === void 0 ? void 0 : _a[0]) && this.vecs[1].equals((_b = m === null || m === void 0 ? void 0 : m.vecs) === null || _b === void 0 ? void 0 : _b[1]);
    }
...
export class MatrixStack2D extends MatrixStack {
    constructor() {
        ...
        this.total_scale = new Vector2D(1, 1);
        this.total_shear = new Vector2D(0, 0);
        this.total_translation = new Vector2D(0, 0);
        this.total_stack = [];
    ...
    apply(v) {
        var _a, _b;
        if (v.dim() < 3) {
            return this.last().multVector(new Vector3D((_a = v.x) !== null && _a !== void 0 ? _a : 0, (_b = v.y) !== null && _b !== void 0 ? _b : 0, 1));
        }
        return this.last().multVector(v);
    }
}
