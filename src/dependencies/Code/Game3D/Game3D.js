...
export class Camera3D {
    ...
    tick(dt, keypress, mousepos, mouseclick) {
        ...
        this.lastMousePos = Object.assign({}, mousepos);
    }
    Hor(keypress) {
    ...
    setUniforms(u_viewMatrix, u_projectionMatrix, u_cameraPosition) {
        var _a, _b, _c;
        (_a = u_viewMatrix === null || u_viewMatrix === void 0 ? void 0 : u_viewMatrix.set) === null || _a === void 0 ? void 0 : _a.call(u_viewMatrix, this.viewMatrix);
        (_b = u_projectionMatrix === null || u_projectionMatrix === void 0 ? void 0 : u_projectionMatrix.set) === null || _b === void 0 ? void 0 : _b.call(u_projectionMatrix, this.projectionMatrix);
        (_c = u_cameraPosition === null || u_cameraPosition === void 0 ? void 0 : u_cameraPosition.set) === null || _c === void 0 ? void 0 : _c.call(u_cameraPosition, this.position);
    }
...
export class LightManager {
    constructor() {
        this.sunLigths = [];
        this.ambientLight = new AmbienLight(Vector3D.Zero.clone());
        this.programs = [];
        this.uniforms = [];
    }
