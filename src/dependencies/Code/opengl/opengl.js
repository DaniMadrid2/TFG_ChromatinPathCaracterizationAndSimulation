...
export function __loadProgramWithShaderFilters(gl, obj, vertexPath, fragmentPath, vertexFilter, fragmentFilter) {
    return __awaiter(this, void 0, void 0, function* () {
        const [program, vert, frag] = yield loadShaders(gl, vertexPath, fragmentPath, vertexFilter, fragmentFilter);
...
export function loadShaders(gl, vertexPath, fragmentPath, vertexFilter = (a) => a, fragmentFilter = (a) => a) {
    return __awaiter(this, void 0, void 0, function* () {
...
export function loadShadersFromString(gl, vertexSource, fragmentSource, vertexFilter = (a) => a, fragmentFilter = (a) => a) {
    return __awaiter(this, void 0, void 0, function* () {
