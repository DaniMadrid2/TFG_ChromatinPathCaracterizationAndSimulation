...
(async ()=>{
    ...
    let {screen:screen_props}=createCanvasNextTo(undefined,"c3","#F3",
...
*/
    ...
    const __gotoRankedCandidate=(rank:number)=>{
        ...
        console.log("C3 rank fallback -> bestTex", {rank,tau:bestTau,subseq:bestSubseq,mode:__getRankMode()});
        return __requestTauRecompute(true);
    };
...
*/
    ...
    console.log("[C3 boot] cuerpo inicial completado");
...
const __backupDefaultScope = "parseTextC23";
...
(xTex as any).__backupVarName = "xTex";
(xTex as any).__backupUniformName = "datosX1";
(xTex as any).__backupProgram = (tauMom as any)?.ID ?? (tauMom as any)?.fragPath ?? "tauMom";
...
(yTex as any).__backupVarName = "yTex";
(yTex as any).__backupUniformName = "datosY1";
(yTex as any).__backupProgram = (tauMom as any)?.ID ?? (tauMom as any)?.fragPath ?? "tauMom";
...
(tauMom1 as any).__backupVarName = "tauMom1";
(tauMom1 as any).__backupUniformName = "tauMom1";
(tauMom1 as any).__backupProgram = (tauMom as any)?.ID ?? (tauMom as any)?.fragPath ?? "tauMom";
...
(tauMom2 as any).__backupVarName = "tauMom2";
(tauMom2 as any).__backupUniformName = "tauMom2";
(tauMom2 as any).__backupProgram = (tauMom as any)?.ID ?? (tauMom as any)?.fragPath ?? "tauMom";
...
(tauXiF as any).__backupVarName = "tauXiF";
(tauXiF as any).__backupUniformName = "tauXiF";
(tauXiF as any).__backupProgram = (tauXi as any)?.ID ?? (tauXi as any)?.fragPath ?? "tauXi";
...
(tauXiS as any).__backupVarName = "tauXiS";
(tauXiS as any).__backupUniformName = "tauXiS";
(tauXiS as any).__backupProgram = (tauXi as any)?.ID ?? (tauXi as any)?.fragPath ?? "tauXi";
...
(tauXiMeta as any).__backupVarName = "tauXiMeta";
(tauXiMeta as any).__backupUniformName = "tauXiMeta";
(tauXiMeta as any).__backupProgram = (tauXi as any)?.ID ?? (tauXi as any)?.fragPath ?? "tauXi";
...
(tauXiFOpt as any).__backupVarName = "tauXiFOpt";
(tauXiFOpt as any).__backupUniformName = "tauXiFOpt";
(tauXiFOpt as any).__backupProgram = (tauAFP as any)?.ID ?? (tauAFP as any)?.fragPath ?? "tauAFP";
...
(tauXiSOpt as any).__backupVarName = "tauXiSOpt";
(tauXiSOpt as any).__backupUniformName = "tauXiSOpt";
(tauXiSOpt as any).__backupProgram = (tauAFP as any)?.ID ?? (tauAFP as any)?.fragPath ?? "tauAFP";
...
(tauXiMetaOpt as any).__backupVarName = "tauXiMetaOpt";
(tauXiMetaOpt as any).__backupUniformName = "tauXiMetaOpt";
(tauXiMetaOpt as any).__backupProgram = (tauAFP as any)?.ID ?? (tauAFP as any)?.fragPath ?? "tauAFP";
...
(tauXiFFinal as any).__backupVarName = "tauXiFFinal";
(tauXiFFinal as any).__backupUniformName = "tauXiFFinal";
(tauXiFFinal as any).__backupProgram = (tauAFPOpt as any)?.ID ?? (tauAFPOpt as any)?.fragPath ?? "tauAFPOpt";
...
(tauXiSFinal as any).__backupVarName = "tauXiSFinal";
(tauXiSFinal as any).__backupUniformName = "tauXiSFinal";
(tauXiSFinal as any).__backupProgram = (tauAFPOpt as any)?.ID ?? (tauAFPOpt as any)?.fragPath ?? "tauAFPOpt";
...
(tauXiMetaFinal as any).__backupVarName = "tauXiMetaFinal";
(tauXiMetaFinal as any).__backupUniformName = "tauXiMetaFinal";
(tauXiMetaFinal as any).__backupProgram = (tauAFPOpt as any)?.ID ?? (tauAFPOpt as any)?.fragPath ?? "tauAFPOpt";
...
(tauNMXiF0 as any).__backupVarName = "tauNMXiF0";
(tauNMXiF0 as any).__backupUniformName = "tauNMXiF0";
(tauNMXiF0 as any).__backupProgram = (tauNMSimplexInit as any)?.ID ?? (tauNMSimplexInit as any)?.fragPath ?? "tauNMSimplexInit";
...
(tauNMXiS0 as any).__backupVarName = "tauNMXiS0";
(tauNMXiS0 as any).__backupUniformName = "tauNMXiS0";
(tauNMXiS0 as any).__backupProgram = (tauNMSimplexInit as any)?.ID ?? (tauNMSimplexInit as any)?.fragPath ?? "tauNMSimplexInit";
...
(tauNMMeta0 as any).__backupVarName = "tauNMMeta0";
(tauNMMeta0 as any).__backupUniformName = "tauNMMeta0";
(tauNMMeta0 as any).__backupProgram = (tauNMSimplexInit as any)?.ID ?? (tauNMSimplexInit as any)?.fragPath ?? "tauNMSimplexInit";
...
(tauNMXiF1 as any).__backupVarName = "tauNMXiF1";
(tauNMXiF1 as any).__backupUniformName = "tauNMXiF1";
(tauNMXiF1 as any).__backupProgram = (tauNMSimplexInit as any)?.ID ?? (tauNMSimplexInit as any)?.fragPath ?? "tauNMSimplexInit";
...
(tauNMXiS1 as any).__backupVarName = "tauNMXiS1";
(tauNMXiS1 as any).__backupUniformName = "tauNMXiS1";
(tauNMXiS1 as any).__backupProgram = (tauNMSimplexInit as any)?.ID ?? (tauNMSimplexInit as any)?.fragPath ?? "tauNMSimplexInit";
...
(tauNMMeta1 as any).__backupVarName = "tauNMMeta1";
(tauNMMeta1 as any).__backupUniformName = "tauNMMeta1";
(tauNMMeta1 as any).__backupProgram = (tauNMSimplexInit as any)?.ID ?? (tauNMSimplexInit as any)?.fragPath ?? "tauNMSimplexInit";
...
(tauNMCost as any).__backupVarName = "tauNMCost";
(tauNMCost as any).__backupUniformName = "tauNMCost";
(tauNMCost as any).__backupProgram = (tauNMSimplexInit as any)?.ID ?? (tauNMSimplexInit as any)?.fragPath ?? "tauNMSimplexInit";
...
(tauAdjFieldsTex as any).__backupVarName = "tauAdjFieldsTex";
(tauAdjFieldsTex as any).__backupUniformName = "tauAdjFields";
(tauAdjFieldsTex as any).__backupProgram = (tauAdjFields as any)?.ID ?? (tauAdjFields as any)?.fragPath ?? "tauAdjFields";
...
(tauAdjDiffOpsTex as any).__backupVarName = "tauAdjDiffOpsTex";
(tauAdjDiffOpsTex as any).__backupUniformName = "tauAdjDiffOps";
(tauAdjDiffOpsTex as any).__backupProgram = (tauAdjDiffOps as any)?.ID ?? (tauAdjDiffOps as any)?.fragPath ?? "tauAdjDiffOps";
...
(tauAdjOperatorTex as any).__backupVarName = "tauAdjOperatorTex";
(tauAdjOperatorTex as any).__backupUniformName = "tauAdjOperator";
(tauAdjOperatorTex as any).__backupProgram = (tauAdjOperator as any)?.ID ?? (tauAdjOperator as any)?.fragPath ?? "tauAdjOperator";
...
(tauAdjExpTex as any).__backupVarName = "tauAdjExpTex";
(tauAdjExpTex as any).__backupUniformName = "tauAdjExp";
(tauAdjExpTex as any).__backupProgram = (tauAdjExp as any)?.ID ?? (tauAdjExp as any)?.fragPath ?? "tauAdjExp";
...
(tauSteadyFPTex as any).__backupVarName = "tauSteadyFPTex";
(tauSteadyFPTex as any).__backupUniformName = "tauSteadyFP";
(tauSteadyFPTex as any).__backupProgram = (tauSteadyFP as any)?.ID ?? (tauSteadyFP as any)?.fragPath ?? "tauSteadyFP";
...
(tauKrylov0Tex as any).__backupVarName = "tauKrylov0Tex";
(tauKrylov0Tex as any).__backupUniformName = "tauKrylov0";
(tauKrylov0Tex as any).__backupProgram = (tauKrylovInit as any)?.ID ?? (tauKrylovInit as any)?.fragPath ?? "tauKrylovInit";
...
(tauArnoldiCoeffTex as any).__backupVarName = "tauArnoldiCoeffTex";
(tauArnoldiCoeffTex as any).__backupUniformName = "tauArnoldiCoeff";
(tauArnoldiCoeffTex as any).__backupProgram = (tauArnoldiCoeff as any)?.ID ?? (tauArnoldiCoeff as any)?.fragPath ?? "tauArnoldiCoeff";
var tauKrylov1Tex = tauArnoldiCoeff.createTexture2D("tauKrylov1", [nBins, tauAdjTauBatch*tauMaxVeces*9], (TexExamples as any).TauFloatTex, null, ["NEAREST", "NEAREST", "CLAMP", "CLAMP"], "TexUnit24");
(tauKrylov1Tex as any).__backupVarName = "tauKrylov1Tex";
(tauKrylov1Tex as any).__backupUniformName = "tauKrylov1";
(tauKrylov1Tex as any).__backupProgram = (tauArnoldiCoeff as any)?.ID ?? (tauArnoldiCoeff as any)?.fragPath ?? "tauArnoldiCoeff";
var tauKrylov2Tex = tauArnoldiCoeff.createTexture2D("tauKrylov2", [nBins, tauAdjTauBatch*tauMaxVeces*9], (TexExamples as any).TauFloatTex, null, ["NEAREST", "NEAREST", "CLAMP", "CLAMP"], "TexUnit25");
(tauKrylov2Tex as any).__backupVarName = "tauKrylov2Tex";
(tauKrylov2Tex as any).__backupUniformName = "tauKrylov2";
(tauKrylov2Tex as any).__backupProgram = (tauArnoldiCoeff as any)?.ID ?? (tauArnoldiCoeff as any)?.fragPath ?? "tauArnoldiCoeff";
var tauKrylov3Tex = tauArnoldiCoeff.createTexture2D("tauKrylov3", [nBins, tauAdjTauBatch*tauMaxVeces*9], (TexExamples as any).TauFloatTex, null, ["NEAREST", "NEAREST", "CLAMP", "CLAMP"], "TexUnit26");
(tauKrylov3Tex as any).__backupVarName = "tauKrylov3Tex";
(tauKrylov3Tex as any).__backupUniformName = "tauKrylov3";
(tauKrylov3Tex as any).__backupProgram = (tauArnoldiCoeff as any)?.ID ?? (tauArnoldiCoeff as any)?.fragPath ?? "tauArnoldiCoeff";
var tauKrylov4Tex = tauArnoldiCoeff.createTexture2D("tauKrylov4", [nBins, tauAdjTauBatch*tauMaxVeces*9], (TexExamples as any).TauFloatTex, null, ["NEAREST", "NEAREST", "CLAMP", "CLAMP"], "TexUnit2");
(tauKrylov4Tex as any).__backupVarName = "tauKrylov4Tex";
(tauKrylov4Tex as any).__backupUniformName = "tauKrylov4";
(tauKrylov4Tex as any).__backupProgram = (tauArnoldiCoeff as any)?.ID ?? (tauArnoldiCoeff as any)?.fragPath ?? "tauArnoldiCoeff";
var tauKrylov5Tex = tauArnoldiCoeff.createTexture2D("tauKrylov5", [nBins, tauAdjTauBatch*tauMaxVeces*9], (TexExamples as any).TauFloatTex, null, ["NEAREST", "NEAREST", "CLAMP", "CLAMP"], "TexUnit3");
(tauKrylov5Tex as any).__backupVarName = "tauKrylov5Tex";
(tauKrylov5Tex as any).__backupUniformName = "tauKrylov5";
(tauKrylov5Tex as any).__backupProgram = (tauArnoldiCoeff as any)?.ID ?? (tauArnoldiCoeff as any)?.fragPath ?? "tauArnoldiCoeff";
...
(tauStatsTex as any).__backupVarName = "tauStatsTex";
(tauStatsTex as any).__backupUniformName = "tauStats";
(tauStatsTex as any).__backupProgram = (tauStats as any)?.ID ?? (tauStats as any)?.fragPath ?? "tauStats";
...
var tauMaskTex = tauMask.createTexture2D("tauModelMask", [tauMaxVeces, tauMaxVeces], (TexExamples as any).TauFloatTex, null, ["NEAREST", "NEAREST", "CLAMP", "CLAMP"], "TexUnit22");
(tauMaskTex as any).__backupVarName = "tauMaskTex";
(tauMaskTex as any).__backupUniformName = "tauModelMask";
(tauMaskTex as any).__backupProgram = (tauMask as any)?.ID ?? (tauMask as any)?.fragPath ?? "tauMask";
...
var tauFPTex = tauFP.createTexture2D("tauFPProxy", [tauMaxVeces, tauMaxVeces], (TexExamples as any).TauFloatTex, null, ["NEAREST", "NEAREST", "CLAMP", "CLAMP"], "TexUnit23");
(tauFPTex as any).__backupVarName = "tauFPTex";
(tauFPTex as any).__backupUniformName = "tauFPProxy";
(tauFPTex as any).__backupProgram = (tauFP as any)?.ID ?? (tauFP as any)?.fragPath ?? "tauFP";
...
var tauKLTex = tauKL.createTexture2D("tauModelKL", [tauMaxVeces, tauMaxVeces], (TexExamples as any).TauFloatTex, null, ["NEAREST", "NEAREST", "CLAMP", "CLAMP"], "TexUnit4");
(tauKLTex as any).__backupVarName = "tauKLTex";
(tauKLTex as any).__backupUniformName = "tauModelKL";
(tauKLTex as any).__backupProgram = (tauKL as any)?.ID ?? (tauKL as any)?.fragPath ?? "tauKL";
...
var tauScoreTex = tauScore.createTexture2D("tauModelScore", [tauMaxVeces, tauMaxVeces], (TexExamples as any).TauFloatTex, null, ["NEAREST", "NEAREST", "CLAMP", "CLAMP"], "TexUnit5");
(tauScoreTex as any).__backupVarName = "tauScoreTex";
(tauScoreTex as any).__backupUniformName = "tauModelScore";
(tauScoreTex as any).__backupProgram = (tauScore as any)?.ID ?? (tauScore as any)?.fragPath ?? "tauScore";
...
(tauBestTex as any).__backupVarName = "tauBestTex";
(tauBestTex as any).__backupUniformName = "tauBest";
(tauBestTex as any).__backupProgram = (tauBest as any)?.ID ?? (tauBest as any)?.fragPath ?? "tauBest";
...
(tauSindyTex as any).__backupVarName = "tauSindyTex";
(tauSindyTex as any).__backupUniformName = "tauSindy";
(tauSindyTex as any).__backupProgram = (tauSindy as any)?.ID ?? (tauSindy as any)?.fragPath ?? "tauSindy";
...
(tauSindyInitTex as any).__backupVarName = "tauSindyInitTex";
(tauSindyInitTex as any).__backupUniformName = "tauSindyInit";
(tauSindyInitTex as any).__backupProgram = (tauSindy as any)?.ID ?? (tauSindy as any)?.fragPath ?? "tauSindy";
...
(tauSindyTau1RefTex as any).__backupVarName = "tauSindyTau1RefTex";
(tauSindyTau1RefTex as any).__backupUniformName = "tauSindyTau1Ref";
(tauSindyTau1RefTex as any).__backupProgram = (tauSindy as any)?.ID ?? (tauSindy as any)?.fragPath ?? "tauSindy";
...
var tauFPStatTex = tauFPStat.createTexture2D("tauFPStationary", [nBins, 1], (TexExamples as any).TauFloatTex, null, ["NEAREST", "NEAREST", "CLAMP", "CLAMP"], "TexUnit24");
(tauFPStatTex as any).__backupVarName = "tauFPStatTex";
(tauFPStatTex as any).__backupUniformName = "tauFPStationary";
(tauFPStatTex as any).__backupProgram = (tauFPStat as any)?.ID ?? (tauFPStat as any)?.fragPath ?? "tauFPStat";
...
drawTau.use?.();
if(typeof tauXiMetaFinal !== "undefined" && tauXiMetaFinal?.bind) tauXiMetaFinal.bind("TexUnit27");
drawTau.bindTexName2TexUnit("tauXiMetaFinal", "TexUnit27");
if(typeof tauBestTex !== "undefined" && tauBestTex?.bind) tauBestTex.bind("TexUnit17");
drawTau.bindTexName2TexUnit("tauBest", "TexUnit17");
if(typeof tauSindyTex !== "undefined" && tauSindyTex?.bind) tauSindyTex.bind("TexUnit6");
drawTau.bindTexName2TexUnit("tauSindy", "TexUnit6");
if(typeof tauSindyInitTex !== "undefined" && tauSindyInitTex?.bind) tauSindyInitTex.bind("TexUnit7");
drawTau.bindTexName2TexUnit("tauSindyInit", "TexUnit7");
if(typeof tauSindyTau1RefTex !== "undefined" && tauSindyTau1RefTex?.bind) tauSindyTau1RefTex.bind("TexUnit8");
drawTau.bindTexName2TexUnit("tauSindyTau1Ref", "TexUnit8");
if(typeof tauMaskTex !== "undefined" && tauMaskTex?.bind) tauMaskTex.bind("TexUnit22");
drawTau.bindTexName2TexUnit("tauModelMask", "TexUnit22");
if(typeof tauFPTex !== "undefined" && tauFPTex?.bind) tauFPTex.bind("TexUnit23");
drawTau.bindTexName2TexUnit("tauFPProxy", "TexUnit23");
if(typeof tauFPStatTex !== "undefined" && tauFPStatTex?.bind) tauFPStatTex.bind("TexUnit24");
drawTau.bindTexName2TexUnit("tauFPStationary", "TexUnit24");
if(typeof tauKLTex !== "undefined" && tauKLTex?.bind) tauKLTex.bind("TexUnit4");
drawTau.bindTexName2TexUnit("tauModelKL", "TexUnit4");
if(typeof tauScoreTex !== "undefined" && tauScoreTex?.bind) tauScoreTex.bind("TexUnit5");
drawTau.bindTexName2TexUnit("tauModelScore", "TexUnit5");
if(typeof tauStatsTex !== "undefined" && tauStatsTex?.bind) tauStatsTex.bind("TexUnit21");
...
var __globalBlockFn_0 = async (dt)=>{ // tick
    ...
    console.log("-> phase 01 tauMom", (tauModelStamp));
    await tauMom.use?.();
    lastUsedProgram = tauMom;
    lastUsedProgram?.use?.();
    (()=>{ const __sz:any = [nBins,tauMaxVeces*tauMaxVeces]; lastUsedProgram?.setViewport(0,0,__sz[0],__sz[1]); })();
    ...
    lastUsedProgram.uNum("tauMin", false, false).set((tauMinVeces));
    lastUsedProgram.uNum("nBins", false, false).set((nBins));
    if(typeof tauMom1 !== "undefined" && tauMom1?.bind) tauMom1.bind("TexUnit14");
    lastUsedProgram.bindTexName2TexUnit("tauMom1", "TexUnit14");
    if(typeof tauMom2 !== "undefined" && tauMom2?.bind) tauMom2.bind("TexUnit15");
    lastUsedProgram.bindTexName2TexUnit("tauMom2", "TexUnit15");
    lastUsedProgram?.drawArrays("TRIANGLES", 0, 6);
    void __backupStoreDrawBlock("drawTriangles", "/parseTextC3/tauXi/", [{ name: "tauXiF", tex: tauXiF }, { name: "tauXiS", tex: tauXiS }, { name: "tauXiMeta", tex: tauXiMeta }], [{ kind: "uniform", name: "tauMax", value: (tauMaxVeces) }, { kind: "uniform", name: "tauMin", value: (tauMinVeces) }, { kind: "uniform", name: "nBins", value: (nBins) }], lastUsedProgram);
    ...
    lastUsedProgram.uNum("tauMin", false, false).set((tauMinVeces));
    lastUsedProgram.uNum("nBins", false, false).set((nBins));
    lastUsedProgram.uNum("lrF", true, false).set((afpLrF));
    lastUsedProgram.uNum("lrS", true, false).set((afpLrS));
    ...
    while(tauAFPOptPass<tauAFPOptMaxPasses && !tauAFPOptDone){
        ...
        while(tauNMInner<tauAFPOptChunk){
            ...
            while(tauAdjX0<tauMaxVeces){
                ...
                lastUsedProgram = tauAdjFields;
                lastUsedProgram?.use?.();
                (()=>{ const __sz:any = [nBins,tauAdjCount*tauMaxVeces*9]; lastUsedProgram?.setViewport(0,0,__sz[0],__sz[1]); })();
                ...
                lastUsedProgram?.drawArrays("TRIANGLES", 0, 6);
                void __backupStoreDrawBlock("drawTriangles", "/parseTextC3/tauAdjFields/", [{ name: "tauAdjFieldsTex", tex: tauAdjFieldsTex }], [{ kind: "uniform", name: "tauMax", value: (tauMaxVeces) }, { kind: "uniform", name: "tauMin", value: (tauMinVeces) }, { kind: "uniform", name: "nBins", value: (nBins) }, { kind: "uniform", name: "tauBatchOffset", value: (tauAdjX0) }, { kind: "uniform", name: "tauBatchCount", value: (tauAdjCount) }], lastUsedProgram);
                await tauAdjDiffOps.use?.();
                lastUsedProgram = tauAdjDiffOps;
                lastUsedProgram?.use?.();
                (()=>{ const __sz:any = [nBins*nBins,tauAdjCount*tauMaxVeces*9]; lastUsedProgram?.setViewport(0,0,__sz[0],__sz[1]); })();
                ...
                lastUsedProgram.bindTexName2TexUnit("tauAdjFields", "TexUnit28");
                lastUsedProgram?.drawArrays("TRIANGLES", 0, 6);
                void __backupStoreDrawBlock("drawTriangles", "/parseTextC3/tauKrylovInit/", [{ name: "tauKrylov0Tex", tex: tauKrylov0Tex }], [{ kind: "uniform", name: "tauMax", value: (tauMaxVeces) }, { kind: "uniform", name: "tauMin", value: (tauMinVeces) }, { kind: "uniform", name: "nBins", value: (nBins) }, { kind: "uniform", name: "tauBatchOffset", value: (tauAdjX0) }, { kind: "uniform", name: "tauBatchCount", value: (tauAdjCount) }], lastUsedProgram);
                await tauKrylovStep.use?.();
                lastUsedProgram = tauKrylovStep;
                lastUsedProgram?.use?.();
                (()=>{ const __sz:any = [nBins,tauAdjCount*tauMaxVeces*9]; lastUsedProgram?.setViewport(0,0,__sz[0],__sz[1]); })();
                ...
                lastUsedProgram?.drawArrays("TRIANGLES", 0, 6);
                void __backupStoreDrawBlock("drawTriangles", "/parseTextC3/tauKrylovStep/", [{ name: "tauKrylov2Tex", tex: tauKrylov2Tex }], [{ kind: "uniform", name: "tauMax", value: (tauMaxVeces) }, { kind: "uniform", name: "tauMin", value: (tauMinVeces) }, { kind: "uniform", name: "nBins", value: (nBins) }, { kind: "uniform", name: "tauBatchOffset", value: (tauAdjX0) }, { kind: "uniform", name: "tauBatchCount", value: (tauAdjCount) }], lastUsedProgram);
                lastUsedProgram?.use?.();
                (()=>{ const __sz:any = [nBins,tauAdjCount*tauMaxVeces*9]; lastUsedProgram?.setViewport(0,0,__sz[0],__sz[1]); })();
                ...
                lastUsedProgram?.drawArrays("TRIANGLES", 0, 6);
                void __backupStoreDrawBlock("drawTriangles", "/parseTextC3/tauKrylovStep/", [{ name: "tauKrylov3Tex", tex: tauKrylov3Tex }], [{ kind: "uniform", name: "tauMax", value: (tauMaxVeces) }, { kind: "uniform", name: "tauMin", value: (tauMinVeces) }, { kind: "uniform", name: "nBins", value: (nBins) }, { kind: "uniform", name: "tauBatchOffset", value: (tauAdjX0) }, { kind: "uniform", name: "tauBatchCount", value: (tauAdjCount) }], lastUsedProgram);
                lastUsedProgram?.use?.();
                (()=>{ const __sz:any = [nBins,tauAdjCount*tauMaxVeces*9]; lastUsedProgram?.setViewport(0,0,__sz[0],__sz[1]); })();
                ...
                lastUsedProgram?.drawArrays("TRIANGLES", 0, 6);
                void __backupStoreDrawBlock("drawTriangles", "/parseTextC3/tauKrylovStep/", [{ name: "tauKrylov4Tex", tex: tauKrylov4Tex }], [{ kind: "uniform", name: "tauMax", value: (tauMaxVeces) }, { kind: "uniform", name: "tauMin", value: (tauMinVeces) }, { kind: "uniform", name: "nBins", value: (nBins) }, { kind: "uniform", name: "tauBatchOffset", value: (tauAdjX0) }, { kind: "uniform", name: "tauBatchCount", value: (tauAdjCount) }], lastUsedProgram);
                lastUsedProgram?.use?.();
                (()=>{ const __sz:any = [nBins,tauAdjCount*tauMaxVeces*9]; lastUsedProgram?.setViewport(0,0,__sz[0],__sz[1]); })();
                ...
                lastUsedProgram?.drawArrays("TRIANGLES", 0, 6);
                void __backupStoreDrawBlock("drawTriangles", "/parseTextC3/tauKrylovStep/", [{ name: "tauKrylov5Tex", tex: tauKrylov5Tex }], [{ kind: "uniform", name: "tauMax", value: (tauMaxVeces) }, { kind: "uniform", name: "tauMin", value: (tauMinVeces) }, { kind: "uniform", name: "nBins", value: (nBins) }, { kind: "uniform", name: "tauBatchOffset", value: (tauAdjX0) }, { kind: "uniform", name: "tauBatchCount", value: (tauAdjCount) }], lastUsedProgram);
                await tauArnoldiCoeff.use?.();
                lastUsedProgram = tauArnoldiCoeff;
                lastUsedProgram?.use?.();
                (()=>{ const __sz:any = [14,tauAdjCount*tauMaxVeces*9]; lastUsedProgram?.setViewport(0,0,__sz[0],__sz[1]); })();
                ...
                if(typeof tauKrylov0Tex !== "undefined" && tauKrylov0Tex?.bind) tauKrylov0Tex.bind("TexUnit23");
                lastUsedProgram.bindTexName2TexUnit("tauKrylov0", "TexUnit23");
                if(typeof tauKrylov1Tex !== "undefined" && tauKrylov1Tex?.bind) tauKrylov1Tex.bind("TexUnit24");
                lastUsedProgram.bindTexName2TexUnit("tauKrylov1", "TexUnit24");
                if(typeof tauKrylov2Tex !== "undefined" && tauKrylov2Tex?.bind) tauKrylov2Tex.bind("TexUnit25");
                lastUsedProgram.bindTexName2TexUnit("tauKrylov2", "TexUnit25");
                if(typeof tauKrylov3Tex !== "undefined" && tauKrylov3Tex?.bind) tauKrylov3Tex.bind("TexUnit26");
                lastUsedProgram.bindTexName2TexUnit("tauKrylov3", "TexUnit26");
                if(typeof tauKrylov4Tex !== "undefined" && tauKrylov4Tex?.bind) tauKrylov4Tex.bind("TexUnit2");
                lastUsedProgram.bindTexName2TexUnit("tauKrylov4", "TexUnit2");
                if(typeof tauKrylov5Tex !== "undefined" && tauKrylov5Tex?.bind) tauKrylov5Tex.bind("TexUnit3");
                lastUsedProgram.bindTexName2TexUnit("tauKrylov5", "TexUnit3");
                lastUsedProgram?.drawArrays("TRIANGLES", 0, 6);
                void __backupStoreDrawBlock("drawTriangles", "/parseTextC3/tauArnoldiCoeff/", [{ name: "tauArnoldiCoeffTex", tex: tauArnoldiCoeffTex }], [{ kind: "uniform", name: "tauMax", value: (tauMaxVeces) }, { kind: "uniform", name: "tauMin", value: (tauMinVeces) }, { kind: "uniform", name: "nBins", value: (nBins) }, { kind: "uniform", name: "tauBatchOffset", value: (tauAdjX0) }, { kind: "uniform", name: "tauBatchCount", value: (tauAdjCount) }, { kind: "uniform", name: "tauArnoldiReorth", value: (Math.max(1, Math.min(4, ~~tauArnoldiReorth))) }, { kind: "uniform", name: "tauArnoldiResidTol", value: (Math.max(1e-4, Math.min(0.9, tauArnoldiResidTol))) }], lastUsedProgram);
                await tauAdjExp.use?.();
                lastUsedProgram = tauAdjExp;
                lastUsedProgram?.use?.();
                (()=>{ const __sz:any = [nBins,tauAdjCount*tauMaxVeces*9]; lastUsedProgram?.setViewport(0,0,__sz[0],__sz[1]); })();
                ...
                if(typeof tauKrylov5Tex !== "undefined" && tauKrylov5Tex?.bind) tauKrylov5Tex.bind("TexUnit3");
                lastUsedProgram.bindTexName2TexUnit("tauKrylov5", "TexUnit3");
                if(typeof tauArnoldiCoeffTex !== "undefined" && tauArnoldiCoeffTex?.bind) tauArnoldiCoeffTex.bind("TexUnit22");
                lastUsedProgram.bindTexName2TexUnit("tauArnoldiCoeff", "TexUnit22");
                lastUsedProgram?.drawArrays("TRIANGLES", 0, 6);
                void __backupStoreDrawBlock("drawTriangles", "/parseTextC3/tauAdjExp/", [{ name: "tauAdjExpTex", tex: tauAdjExpTex }], [{ kind: "uniform", name: "tauMax", value: (tauMaxVeces) }, { kind: "uniform", name: "tauMin", value: (tauMinVeces) }, { kind: "uniform", name: "nBins", value: (nBins) }, { kind: "uniform", name: "tauBatchOffset", value: (tauAdjX0) }, { kind: "uniform", name: "tauBatchCount", value: (tauAdjCount) }, { kind: "uniform", name: "adjointTauScale", value: (tauEStar * dtSample) }, { kind: "uniform", name: "tauExpTerms", value: (Math.max(1, Math.min(4, ~~tauExpTerms))) }], lastUsedProgram);
                await tauSteadyFP.use?.();
                lastUsedProgram = tauSteadyFP;
                lastUsedProgram?.use?.();
                (()=>{ const __sz:any = [nBins,tauAdjCount*tauMaxVeces*9]; lastUsedProgram?.setViewport(0,0,__sz[0],__sz[1]); })();
                ...
                lastUsedProgram.bindTexName2TexUnit("tauAdjFields", "TexUnit28");
                lastUsedProgram?.drawArrays("TRIANGLES", 0, 6);
                void __backupStoreDrawBlock("drawTriangles", "/parseTextC3/tauSteadyFP/", [{ name: "tauSteadyFPTex", tex: tauSteadyFPTex }], [{ kind: "uniform", name: "tauMax", value: (tauMaxVeces) }, { kind: "uniform", name: "tauMin", value: (tauMinVeces) }, { kind: "uniform", name: "nBins", value: (nBins) }, { kind: "uniform", name: "tauBatchOffset", value: (tauAdjX0) }, { kind: "uniform", name: "tauBatchCount", value: (tauAdjCount) }, { kind: "uniform", name: "fpLogSpanMax", value: (fpLogSpanMax) }, { kind: "uniform", name: "steadyFPGaugeMode", value: ((steadyFPSolverMode==="fourier_zero_mode_like")?1:0) }], lastUsedProgram);
                await tauAdjCost.use?.();
                lastUsedProgram = tauAdjCost;
                lastUsedProgram?.use?.();
                (()=>{ const __sz:any = [tauAdjCount,tauMaxVeces*9]; lastUsedProgram?.setViewport(0,0,__sz[0],__sz[1]); })();
                ...
                lastUsedProgram.uNum("tauBatchOffset", false, false).set((tauAdjX0));
                lastUsedProgram.uNum("tauBatchCount", false, false).set((tauAdjCount));
                lastUsedProgram.uNum("l2F", true, false).set((afpOptL2F));
                lastUsedProgram.uNum("l2S", true, false).set((afpOptL2S));
                lastUsedProgram.uNum("adjointTauScale", true, false).set((tauEStar * dtSample));
            ...
            if(typeof tauNMCost !== "undefined" && tauNMCost?.bind) tauNMCost.bind("TexUnit11");
        ...
        while(tauAdjX1<tauMaxVeces){
            ...
            lastUsedProgram = tauAdjFields;
            lastUsedProgram?.use?.();
            (()=>{ const __sz:any = [nBins,tauAdjCount1*tauMaxVeces*9]; lastUsedProgram?.setViewport(0,0,__sz[0],__sz[1]); })();
            var tauAdjFieldsFBO = (typeof tauAdjFieldsFBO !== "undefined" && tauAdjFieldsFBO) ? tauAdjFieldsFBO.bind(["ColAtch0"]) : lastUsedProgram.cFrameBuffer().bind(["ColAtch0"]);
            tauAdjFieldsFBO.bindColorBuffer(tauAdjFieldsTex, "ColAtch0");
            lastUsedProgram.uNum("tauMax", false, false).set((tauMaxVeces));
            lastUsedProgram.uNum("tauMin", false, false).set((tauMinVeces));
            ...
            lastUsedProgram.bindTexName2TexUnit("tauNMMetaRead", "TexUnit6");
            lastUsedProgram?.drawArrays("TRIANGLES", 0, 6);
            void __backupStoreDrawBlock("drawTriangles", "/parseTextC3/tauAdjFields/", [{ name: "tauAdjFieldsTex", tex: tauAdjFieldsTex }], [{ kind: "uniform", name: "tauMax", value: (tauMaxVeces) }, { kind: "uniform", name: "tauMin", value: (tauMinVeces) }, { kind: "uniform", name: "nBins", value: (nBins) }, { kind: "uniform", name: "tauBatchOffset", value: (tauAdjX1) }, { kind: "uniform", name: "tauBatchCount", value: (tauAdjCount1) }], lastUsedProgram);
            await tauAdjDiffOps.use?.();
            lastUsedProgram = tauAdjDiffOps;
            lastUsedProgram?.use?.();
            (()=>{ const __sz:any = [nBins*nBins,tauAdjCount1*tauMaxVeces*9]; lastUsedProgram?.setViewport(0,0,__sz[0],__sz[1]); })();
            var tauAdjDiffOpsFBO = (typeof tauAdjDiffOpsFBO !== "undefined" && tauAdjDiffOpsFBO) ? tauAdjDiffOpsFBO.bind(["ColAtch0"]) : lastUsedProgram.cFrameBuffer().bind(["ColAtch0"]);
            tauAdjDiffOpsFBO.bindColorBuffer(tauAdjDiffOpsTex, "ColAtch0");
            lastUsedProgram.uNum("tauMax", false, false).set((tauMaxVeces));
            lastUsedProgram.uNum("tauMin", false, false).set((tauMinVeces));
            ...
            lastUsedProgram.bindTexName2TexUnit("tauAdjFields", "TexUnit28");
            lastUsedProgram?.drawArrays("TRIANGLES", 0, 6);
            void __backupStoreDrawBlock("drawTriangles", "/parseTextC3/tauKrylovInit/", [{ name: "tauKrylov0Tex", tex: tauKrylov0Tex }], [{ kind: "uniform", name: "tauMax", value: (tauMaxVeces) }, { kind: "uniform", name: "tauMin", value: (tauMinVeces) }, { kind: "uniform", name: "nBins", value: (nBins) }, { kind: "uniform", name: "tauBatchOffset", value: (tauAdjX1) }, { kind: "uniform", name: "tauBatchCount", value: (tauAdjCount1) }], lastUsedProgram);
            await tauKrylovStep.use?.();
            lastUsedProgram = tauKrylovStep;
            lastUsedProgram?.use?.();
            (()=>{ const __sz:any = [nBins,tauAdjCount1*tauMaxVeces*9]; lastUsedProgram?.setViewport(0,0,__sz[0],__sz[1]); })();
            ...
            lastUsedProgram.bindTexName2TexUnit("tauKrylovPrev", "TexUnit24");
            lastUsedProgram?.drawArrays("TRIANGLES", 0, 6);
            void __backupStoreDrawBlock("drawTriangles", "/parseTextC3/tauKrylovStep/", [{ name: "tauKrylov2Tex", tex: tauKrylov2Tex }], [{ kind: "uniform", name: "tauMax", value: (tauMaxVeces) }, { kind: "uniform", name: "tauMin", value: (tauMinVeces) }, { kind: "uniform", name: "nBins", value: (nBins) }, { kind: "uniform", name: "tauBatchOffset", value: (tauAdjX1) }, { kind: "uniform", name: "tauBatchCount", value: (tauAdjCount1) }], lastUsedProgram);
            lastUsedProgram?.use?.();
            (()=>{ const __sz:any = [nBins,tauAdjCount1*tauMaxVeces*9]; lastUsedProgram?.setViewport(0,0,__sz[0],__sz[1]); })();
            var tauKrylov3FBO = (typeof tauKrylov3FBO !== "undefined" && tauKrylov3FBO) ? tauKrylov3FBO.bind(["ColAtch0"]) : lastUsedProgram.cFrameBuffer().bind(["ColAtch0"]);
            tauKrylov3FBO.bindColorBuffer(tauKrylov3Tex, "ColAtch0");
            ...
            lastUsedProgram.bindTexName2TexUnit("tauKrylovPrev", "TexUnit25");
            lastUsedProgram?.drawArrays("TRIANGLES", 0, 6);
            void __backupStoreDrawBlock("drawTriangles", "/parseTextC3/tauKrylovStep/", [{ name: "tauKrylov3Tex", tex: tauKrylov3Tex }], [{ kind: "uniform", name: "tauMax", value: (tauMaxVeces) }, { kind: "uniform", name: "tauMin", value: (tauMinVeces) }, { kind: "uniform", name: "nBins", value: (nBins) }, { kind: "uniform", name: "tauBatchOffset", value: (tauAdjX1) }, { kind: "uniform", name: "tauBatchCount", value: (tauAdjCount1) }], lastUsedProgram);
            lastUsedProgram?.use?.();
            (()=>{ const __sz:any = [nBins,tauAdjCount1*tauMaxVeces*9]; lastUsedProgram?.setViewport(0,0,__sz[0],__sz[1]); })();
            var tauKrylov4FBO = (typeof tauKrylov4FBO !== "undefined" && tauKrylov4FBO) ? tauKrylov4FBO.bind(["ColAtch0"]) : lastUsedProgram.cFrameBuffer().bind(["ColAtch0"]);
            tauKrylov4FBO.bindColorBuffer(tauKrylov4Tex, "ColAtch0");
            ...
            lastUsedProgram.bindTexName2TexUnit("tauKrylovPrev", "TexUnit26");
            lastUsedProgram?.drawArrays("TRIANGLES", 0, 6);
            void __backupStoreDrawBlock("drawTriangles", "/parseTextC3/tauKrylovStep/", [{ name: "tauKrylov4Tex", tex: tauKrylov4Tex }], [{ kind: "uniform", name: "tauMax", value: (tauMaxVeces) }, { kind: "uniform", name: "tauMin", value: (tauMinVeces) }, { kind: "uniform", name: "nBins", value: (nBins) }, { kind: "uniform", name: "tauBatchOffset", value: (tauAdjX1) }, { kind: "uniform", name: "tauBatchCount", value: (tauAdjCount1) }], lastUsedProgram);
            lastUsedProgram?.use?.();
            (()=>{ const __sz:any = [nBins,tauAdjCount1*tauMaxVeces*9]; lastUsedProgram?.setViewport(0,0,__sz[0],__sz[1]); })();
            var tauKrylov5FBO = (typeof tauKrylov5FBO !== "undefined" && tauKrylov5FBO) ? tauKrylov5FBO.bind(["ColAtch0"]) : lastUsedProgram.cFrameBuffer().bind(["ColAtch0"]);
            tauKrylov5FBO.bindColorBuffer(tauKrylov5Tex, "ColAtch0");
            ...
            lastUsedProgram.bindTexName2TexUnit("tauKrylovPrev", "TexUnit2");
            lastUsedProgram?.drawArrays("TRIANGLES", 0, 6);
            void __backupStoreDrawBlock("drawTriangles", "/parseTextC3/tauKrylovStep/", [{ name: "tauKrylov5Tex", tex: tauKrylov5Tex }], [{ kind: "uniform", name: "tauMax", value: (tauMaxVeces) }, { kind: "uniform", name: "tauMin", value: (tauMinVeces) }, { kind: "uniform", name: "nBins", value: (nBins) }, { kind: "uniform", name: "tauBatchOffset", value: (tauAdjX1) }, { kind: "uniform", name: "tauBatchCount", value: (tauAdjCount1) }], lastUsedProgram);
            await tauArnoldiCoeff.use?.();
            lastUsedProgram = tauArnoldiCoeff;
            lastUsedProgram?.use?.();
            (()=>{ const __sz:any = [14,tauAdjCount1*tauMaxVeces*9]; lastUsedProgram?.setViewport(0,0,__sz[0],__sz[1]); })();
            var tauArnoldiCoeffFBO = (typeof tauArnoldiCoeffFBO !== "undefined" && tauArnoldiCoeffFBO) ? tauArnoldiCoeffFBO.bind(["ColAtch0"]) : lastUsedProgram.cFrameBuffer().bind(["ColAtch0"]);
            tauArnoldiCoeffFBO.bindColorBuffer(tauArnoldiCoeffTex, "ColAtch0");
            lastUsedProgram.uNum("tauMax", false, false).set((tauMaxVeces));
            lastUsedProgram.uNum("tauMin", false, false).set((tauMinVeces));
            ...
            lastUsedProgram.bindTexName2TexUnit("tauKrylov5", "TexUnit3");
            lastUsedProgram?.drawArrays("TRIANGLES", 0, 6);
            void __backupStoreDrawBlock("drawTriangles", "/parseTextC3/tauArnoldiCoeff/", [{ name: "tauArnoldiCoeffTex", tex: tauArnoldiCoeffTex }], [{ kind: "uniform", name: "tauMax", value: (tauMaxVeces) }, { kind: "uniform", name: "tauMin", value: (tauMinVeces) }, { kind: "uniform", name: "nBins", value: (nBins) }, { kind: "uniform", name: "tauBatchOffset", value: (tauAdjX1) }, { kind: "uniform", name: "tauBatchCount", value: (tauAdjCount1) }, { kind: "uniform", name: "tauArnoldiReorth", value: (Math.max(1, Math.min(4, ~~tauArnoldiReorth))) }, { kind: "uniform", name: "tauArnoldiResidTol", value: (Math.max(1e-4, Math.min(0.9, tauArnoldiResidTol))) }], lastUsedProgram);
            await tauAdjExp.use?.();
            lastUsedProgram = tauAdjExp;
            lastUsedProgram?.use?.();
            (()=>{ const __sz:any = [nBins,tauAdjCount1*tauMaxVeces*9]; lastUsedProgram?.setViewport(0,0,__sz[0],__sz[1]); })();
            ...
            lastUsedProgram.bindTexName2TexUnit("tauArnoldiCoeff", "TexUnit22");
            lastUsedProgram?.drawArrays("TRIANGLES", 0, 6);
            void __backupStoreDrawBlock("drawTriangles", "/parseTextC3/tauAdjExp/", [{ name: "tauAdjExpTex", tex: tauAdjExpTex }], [{ kind: "uniform", name: "tauMax", value: (tauMaxVeces) }, { kind: "uniform", name: "tauMin", value: (tauMinVeces) }, { kind: "uniform", name: "nBins", value: (nBins) }, { kind: "uniform", name: "tauBatchOffset", value: (tauAdjX1) }, { kind: "uniform", name: "tauBatchCount", value: (tauAdjCount1) }, { kind: "uniform", name: "adjointTauScale", value: (tauEStar * dtSample) }, { kind: "uniform", name: "tauExpTerms", value: (Math.max(1, Math.min(4, ~~tauExpTerms))) }], lastUsedProgram);
            await tauSteadyFP.use?.();
            lastUsedProgram = tauSteadyFP;
            lastUsedProgram?.use?.();
            (()=>{ const __sz:any = [nBins,tauAdjCount1*tauMaxVeces*9]; lastUsedProgram?.setViewport(0,0,__sz[0],__sz[1]); })();
            ...
            lastUsedProgram.bindTexName2TexUnit("tauAdjFields", "TexUnit28");
            lastUsedProgram?.drawArrays("TRIANGLES", 0, 6);
            void __backupStoreDrawBlock("drawTriangles", "/parseTextC3/tauSteadyFP/", [{ name: "tauSteadyFPTex", tex: tauSteadyFPTex }], [{ kind: "uniform", name: "tauMax", value: (tauMaxVeces) }, { kind: "uniform", name: "tauMin", value: (tauMinVeces) }, { kind: "uniform", name: "nBins", value: (nBins) }, { kind: "uniform", name: "tauBatchOffset", value: (tauAdjX1) }, { kind: "uniform", name: "tauBatchCount", value: (tauAdjCount1) }, { kind: "uniform", name: "fpLogSpanMax", value: (fpLogSpanMax) }, { kind: "uniform", name: "steadyFPGaugeMode", value: ((steadyFPSolverMode==="fourier_zero_mode_like")?1:0) }], lastUsedProgram);
            await tauAdjCost.use?.();
            lastUsedProgram = tauAdjCost;
            lastUsedProgram?.use?.();
            (()=>{ const __sz:any = [tauAdjCount1,tauMaxVeces*9]; lastUsedProgram?.setViewport(0,0,__sz[0],__sz[1]); })();
            var tauNMCostFBO = (typeof tauNMCostFBO !== "undefined" && tauNMCostFBO) ? tauNMCostFBO.bind(["ColAtch0"]) : lastUsedProgram.cFrameBuffer().bind(["ColAtch0"]);
            tauNMCostFBO.bindColorBuffer(tauNMCost, "ColAtch0");
            lastUsedProgram.uNum("tauMax", false, false).set((tauMaxVeces));
            lastUsedProgram.uNum("tauMin", false, false).set((tauMinVeces));
        ...
        lastUsedProgram.bindTexName2TexUnit("tauXiMetaOpt", "TexUnit20");
        lastUsedProgram?.drawArrays("TRIANGLES", 0, 6);
        void __backupStoreDrawBlock("drawTriangles", "/parseTextC3/tauNMFinalize/", [{ name: "tauXiFFinal", tex: tauXiFFinal }, { name: "tauXiSFinal", tex: tauXiSFinal }, { name: "tauXiMetaFinal", tex: tauXiMetaFinal }], [{ kind: "uniform", name: "tauMax", value: (tauMaxVeces) }, { kind: "uniform", name: "tauMin", value: (tauMinVeces) }], lastUsedProgram);
        gl.finish();
    ...
    console.log("-> phase 04 tauStats", (Array.from(tauAFPFBO.readColorAttachment(2,0,0,4,1,TexExamples.RGBAFloat16,4))));
    await tauStats.use?.();
    lastUsedProgram = tauStats;
    lastUsedProgram?.use?.();
    ...
    lastUsedProgram?.drawArrays("TRIANGLES", 0, 6);
    void __backupStoreDrawBlock("drawTriangles", "/parseTextC3/tauStats/", [{ name: "tauStatsTex", tex: tauStatsTex }], [{ kind: "uniform", name: "tauMax", value: (tauMaxVeces) }, { kind: "uniform", name: "tauMin", value: (tauMinVeces) }, { kind: "uniform", name: "keepPercent", value: (keepTopPercent) }], lastUsedProgram);
    await tauMask.use?.();
    lastUsedProgram = tauMask;
    lastUsedProgram?.use?.();
    (()=>{ const __sz:any = [tauMaxVeces,tauMaxVeces]; lastUsedProgram?.setViewport(0,0,__sz[0],__sz[1]); })();
    ...
    lastUsedProgram?.drawArrays("TRIANGLES", 0, 6);
    void __backupStoreDrawBlock("drawTriangles", "/parseTextC3/tauMask/", [{ name: "tauMaskTex", tex: tauMaskTex }], [{ kind: "uniform", name: "tauMax", value: (tauMaxVeces) }, { kind: "uniform", name: "tauMin", value: (tauMinVeces) }], lastUsedProgram);
    ...
    if(typeof tauMom1 !== "undefined" && tauMom1?.bind) tauMom1.bind("TexUnit14");
    lastUsedProgram.bindTexName2TexUnit("tauMom1", "TexUnit14");
    if(typeof tauXiFFinal !== "undefined" && tauXiFFinal?.bind) tauXiFFinal.bind("TexUnit25");
    lastUsedProgram.bindTexName2TexUnit("tauXiFFinal", "TexUnit25");
    if(typeof tauXiSFinal !== "undefined" && tauXiSFinal?.bind) tauXiSFinal.bind("TexUnit26");
    ...
    lastUsedProgram?.drawArrays("TRIANGLES", 0, 6);
    void __backupStoreDrawBlock("drawTriangles", "/parseTextC3/tauFP/", [{ name: "tauFPTex", tex: tauFPTex }], [{ kind: "uniform", name: "tauMax", value: (tauMaxVeces) }, { kind: "uniform", name: "tauMin", value: (tauMinVeces) }, { kind: "uniform", name: "nBins", value: (nBins) }, { kind: "uniform", name: "logSpanMax", value: (fpLogSpanMax) }], lastUsedProgram);
    ...
    lastUsedProgram.bindTexName2TexUnit("tauXiMetaFinal", "TexUnit27");
    lastUsedProgram?.drawArrays("TRIANGLES", 0, 6);
    void __backupStoreDrawBlock("drawTriangles", "/parseTextC3/tauKL/", [{ name: "tauKLTex", tex: tauKLTex }], [{ kind: "uniform", name: "tauMax", value: (tauMaxVeces) }, { kind: "uniform", name: "tauMin", value: (tauMinVeces) }, { kind: "uniform", name: "nBins", value: (nBins) }, { kind: "uniform", name: "spanMax", value: (modelKLSpanMax) }], lastUsedProgram);
    ...
    lastUsedProgram.uNum("tauMax", false, false).set((tauMaxVeces));
    lastUsedProgram.uNum("tauMin", false, false).set((tauMinVeces));
    lastUsedProgram.uNum("wCost", true, false).set((scoreWCost));
    lastUsedProgram.uNum("wKL", true, false).set((scoreWKL));
    ...
    lastUsedProgram.bindTexName2TexUnit("tauStats", "TexUnit21");
    lastUsedProgram?.drawArrays("TRIANGLES", 0, 6);
    void __backupStoreDrawBlock("drawTriangles", "/parseTextC3/tauScore/", [{ name: "tauScoreTex", tex: tauScoreTex }], [{ kind: "uniform", name: "tauMax", value: (tauMaxVeces) }, { kind: "uniform", name: "tauMin", value: (tauMinVeces) }, { kind: "uniform", name: "wCost", value: (scoreWCost) }, { kind: "uniform", name: "wKL", value: (scoreWKL) }, { kind: "uniform", name: "wSpan", value: (scoreWSpan) }, { kind: "uniform", name: "klMax", value: (scoreKLMax) }, { kind: "uniform", name: "scoreMax", value: (scoreMaxCut) }], lastUsedProgram);
    ...
    lastUsedProgram?.drawArrays("TRIANGLES", 0, 6);
    void __backupStoreDrawBlock("drawTriangles", "/parseTextC3/tauBest/", [{ name: "tauBestTex", tex: tauBestTex }], [{ kind: "uniform", name: "tauMax", value: (tauMaxVeces) }, { kind: "uniform", name: "tauMin", value: (tauMinVeces) }, { kind: "uniform", name: "useMask", value: 1 }, { kind: "uniform", name: "useFP", value: (!!useFPFilter?1:0) }, { kind: "uniform", name: "useScore", value: (!!useScoreSelection?1:0) }], lastUsedProgram);
    ...
    lastUsedProgram?.use?.();
    (()=>{ const __sz:any = [nBins,1]; lastUsedProgram?.setViewport(0,0,__sz[0],__sz[1]); })();
    ...
    if(typeof tauMom1 !== "undefined" && tauMom1?.bind) tauMom1.bind("TexUnit14");
    lastUsedProgram.bindTexName2TexUnit("tauMom1", "TexUnit14");
    if(typeof tauXiF !== "undefined" && tauXiF?.bind) tauXiF.bind("TexUnit18");
    lastUsedProgram.bindTexName2TexUnit("tauXiF", "TexUnit18");
    if(typeof tauXiS !== "undefined" && tauXiS?.bind) tauXiS.bind("TexUnit19");
    lastUsedProgram.bindTexName2TexUnit("tauXiS", "TexUnit19");
    if(typeof tauBestTex !== "undefined" && tauBestTex?.bind) tauBestTex.bind("TexUnit17");
    lastUsedProgram.bindTexName2TexUnit("tauBest", "TexUnit17");
    lastUsedProgram?.drawArrays("TRIANGLES", 0, 6);
    void __backupStoreDrawBlock("drawTriangles", "/parseTextC3/tauSindy/", [{ name: "tauSindyInitTex", tex: tauSindyInitTex }], [{ kind: "uniform", name: "tauMax", value: (tauMaxVeces) }, { kind: "uniform", name: "nBins", value: (nBins) }, { kind: "uniform", name: "selectedTau", value: (bestTau) }, { kind: "uniform", name: "selectedSubseq", value: (bestSubseq) }, { kind: "uniform", name: "useSelected", value: 1 }], lastUsedProgram);
    lastUsedProgram?.use?.();
    (()=>{ const __sz:any = [nBins,1]; lastUsedProgram?.setViewport(0,0,__sz[0],__sz[1]); })();
    ...
    lastUsedProgram.bindTexName2TexUnit("tauBest", "TexUnit17");
    lastUsedProgram?.drawArrays("TRIANGLES", 0, 6);
    void __backupStoreDrawBlock("drawTriangles", "/parseTextC3/tauFPStat/", [{ name: "tauFPStatTex", tex: tauFPStatTex }], [{ kind: "uniform", name: "tauMax", value: (tauMaxVeces) }, { kind: "uniform", name: "tauMin", value: (tauMinVeces) }, { kind: "uniform", name: "nBins", value: (nBins) }, { kind: "uniform", name: "selectedTau", value: (bestTau) }, { kind: "uniform", name: "selectedSubseq", value: (bestSubseq) }, { kind: "uniform", name: "useSelected", value: 1 }], lastUsedProgram);
    if(tauDebugFrames>0){
...
var __globalBlockFn_1 = async (dt)=>{ // drawTauPanel
    ...
    lastUsedProgram.bindTexName2TexUnit("tauBest", "TexUnit17");
    lastUsedProgram?.drawArrays("TRIANGLES", 0, 6);
    void __backupStoreDrawBlock("drawTriangles", "/parseTextC3/tauSindyPreview/", [{ name: "tauSindyTex", tex: tauSindyTex }], [{ kind: "uniform", name: "tauMax", value: (tauMaxVeces) }, { kind: "uniform", name: "nBins", value: (nBins) }, { kind: "uniform", name: "selectedTau", value: (bestTau) }, { kind: "uniform", name: "selectedSubseq", value: (bestSubseq) }, { kind: "uniform", name: "useSelected", value: 1 }], lastUsedProgram);
    await tauFPStat.use?.();
    lastUsedProgram = tauFPStat;
    tauFPStat.VAO.bind();
    lastUsedProgram?.use?.();
    ...
    lastUsedProgram.bindTexName2TexUnit("tauBest", "TexUnit17");
    lastUsedProgram?.drawArrays("TRIANGLES", 0, 6);
    void __backupStoreDrawBlock("drawTriangles", "/parseTextC3/tauFPStatPreview/", [{ name: "tauFPStatTex", tex: tauFPStatTex }], [{ kind: "uniform", name: "tauMax", value: (tauMaxVeces) }, { kind: "uniform", name: "tauMin", value: (tauMinVeces) }, { kind: "uniform", name: "nBins", value: (nBins) }, { kind: "uniform", name: "selectedTau", value: (bestTau) }, { kind: "uniform", name: "selectedSubseq", value: (bestSubseq) }, { kind: "uniform", name: "useSelected", value: 1 }], lastUsedProgram);
    ...
    if(useLSView){
    drawTau.use?.();
    if(typeof tauXiMetaFinal !== "undefined" && tauXiMetaFinal?.bind) tauXiMetaFinal.bind("TexUnit16");
    ...
    console.log("C2 drawTauPanel", (bestTau), (bestSubseq), (gl.getParameter(gl.FRAMEBUFFER_BINDING)), (showTauCurves), (!!((window as any).simDataX)), (!!((window as any).simDataY)), (~~((window as any).simStampX||0)), (~~((window as any).simStampY||0)));
    console.log((Array.from(tauSindyPreviewSample)), "C2 tauSindyPreview sample [x,f,s,a] bins 0..7");
    console.log((Array.from(tauFPStatPreviewSample)), "C2 tauFPStatPreview sample [pHist,pInit,pFinal,valid] bins 0..7");
    c2DrawLogFrames -= 1;
    }
