...
(async () => {
    ...
    */
    ...
    let datosY1 = null;
    let NMuestras1 = 0;
    let chromatinIndex = Math.max(1, Number(window.chromatinIndex ?? 1) || 1);
    window.chromatinIndex = chromatinIndex;
    const __safeCfg = (getter, fallback) => {
        try {
            const v = getter();
    ...
    */
    ...
    xTex.__backupVarName = "xTex";
    xTex.__backupUniformName = "datosX1";
    xTex.__backupProgram = tauMom?.ID ?? tauMom?.fragPath ?? "tauMom";
    var yTex = tauMom.createTexture2D("datosY1", [NMuestras1, 1], TexExamples.RFloat, datosY1, ["NEAREST", "NEAREST", "CLAMP", "CLAMP"], "TexUnit11");
    yTex.__backupVarName = "yTex";
    yTex.__backupUniformName = "datosY1";
    yTex.__backupProgram = tauMom?.ID ?? tauMom?.fragPath ?? "tauMom";
    var tauMom1 = tauMom.createTexture2D("tauMom1", [nBins, tauMaxVeces * tauMaxVeces], TexExamples.TauFloatTex, null, ["NEAREST", "NEAREST", "CLAMP", "CLAMP"], "TexUnit14");
    tauMom1.__backupVarName = "tauMom1";
    tauMom1.__backupUniformName = "tauMom1";
    tauMom1.__backupProgram = tauMom?.ID ?? tauMom?.fragPath ?? "tauMom";
    var tauMom2 = tauMom.createTexture2D("tauMom2", [nBins, tauMaxVeces * tauMaxVeces], TexExamples.TauFloatTex, null, ["NEAREST", "NEAREST", "CLAMP", "CLAMP"], "TexUnit15");
    tauMom2.__backupVarName = "tauMom2";
    tauMom2.__backupUniformName = "tauMom2";
    tauMom2.__backupProgram = tauMom?.ID ?? tauMom?.fragPath ?? "tauMom";
    ...
    var tauXiF = tauXi.createTexture2D("tauXiF", [tauMaxVeces, tauMaxVeces], TexExamples.TauFloatTex, null, ["NEAREST", "NEAREST", "CLAMP", "CLAMP"], "TexUnit12");
    tauXiF.__backupVarName = "tauXiF";
    tauXiF.__backupUniformName = "tauXiF";
    tauXiF.__backupProgram = tauXi?.ID ?? tauXi?.fragPath ?? "tauXi";
    var tauXiS = tauXi.createTexture2D("tauXiS", [tauMaxVeces, tauMaxVeces], TexExamples.TauFloatTex, null, ["NEAREST", "NEAREST", "CLAMP", "CLAMP"], "TexUnit13");
    tauXiS.__backupVarName = "tauXiS";
    tauXiS.__backupUniformName = "tauXiS";
    tauXiS.__backupProgram = tauXi?.ID ?? tauXi?.fragPath ?? "tauXi";
    var tauXiMeta = tauXi.createTexture2D("tauXiMeta", [tauMaxVeces, tauMaxVeces], TexExamples.TauFloatTex, null, ["NEAREST", "NEAREST", "CLAMP", "CLAMP"], "TexUnit16");
    tauXiMeta.__backupVarName = "tauXiMeta";
    tauXiMeta.__backupUniformName = "tauXiMeta";
    tauXiMeta.__backupProgram = tauXi?.ID ?? tauXi?.fragPath ?? "tauXi";
    ...
    var tauXiFOpt = tauAFP.createTexture2D("tauXiFOpt", [tauMaxVeces, tauMaxVeces], TexExamples.TauFloatTex, null, ["NEAREST", "NEAREST", "CLAMP", "CLAMP"], "TexUnit18");
    tauXiFOpt.__backupVarName = "tauXiFOpt";
    tauXiFOpt.__backupUniformName = "tauXiFOpt";
    tauXiFOpt.__backupProgram = tauAFP?.ID ?? tauAFP?.fragPath ?? "tauAFP";
    var tauXiSOpt = tauAFP.createTexture2D("tauXiSOpt", [tauMaxVeces, tauMaxVeces], TexExamples.TauFloatTex, null, ["NEAREST", "NEAREST", "CLAMP", "CLAMP"], "TexUnit19");
    tauXiSOpt.__backupVarName = "tauXiSOpt";
    tauXiSOpt.__backupUniformName = "tauXiSOpt";
    tauXiSOpt.__backupProgram = tauAFP?.ID ?? tauAFP?.fragPath ?? "tauAFP";
    var tauXiMetaOpt = tauAFP.createTexture2D("tauXiMetaOpt", [tauMaxVeces, tauMaxVeces], TexExamples.TauFloatTex, null, ["NEAREST", "NEAREST", "CLAMP", "CLAMP"], "TexUnit20");
    tauXiMetaOpt.__backupVarName = "tauXiMetaOpt";
    tauXiMetaOpt.__backupUniformName = "tauXiMetaOpt";
    tauXiMetaOpt.__backupProgram = tauAFP?.ID ?? tauAFP?.fragPath ?? "tauAFP";
    ...
    var tauXiFFinal = tauAFPOpt.createTexture2D("tauXiFFinal", [tauMaxVeces, tauMaxVeces], TexExamples.TauFloatTex, null, ["NEAREST", "NEAREST", "CLAMP", "CLAMP"], "TexUnit25");
    tauXiFFinal.__backupVarName = "tauXiFFinal";
    tauXiFFinal.__backupUniformName = "tauXiFFinal";
    tauXiFFinal.__backupProgram = tauAFPOpt?.ID ?? tauAFPOpt?.fragPath ?? "tauAFPOpt";
    var tauXiSFinal = tauAFPOpt.createTexture2D("tauXiSFinal", [tauMaxVeces, tauMaxVeces], TexExamples.TauFloatTex, null, ["NEAREST", "NEAREST", "CLAMP", "CLAMP"], "TexUnit26");
    tauXiSFinal.__backupVarName = "tauXiSFinal";
    tauXiSFinal.__backupUniformName = "tauXiSFinal";
    tauXiSFinal.__backupProgram = tauAFPOpt?.ID ?? tauAFPOpt?.fragPath ?? "tauAFPOpt";
    var tauXiMetaFinal = tauAFPOpt.createTexture2D("tauXiMetaFinal", [tauMaxVeces, tauMaxVeces], TexExamples.TauFloatTex, null, ["NEAREST", "NEAREST", "CLAMP", "CLAMP"], "TexUnit27");
    tauXiMetaFinal.__backupVarName = "tauXiMetaFinal";
    tauXiMetaFinal.__backupUniformName = "tauXiMetaFinal";
    tauXiMetaFinal.__backupProgram = tauAFPOpt?.ID ?? tauAFPOpt?.fragPath ?? "tauAFPOpt";
    ...
    var tauNMXiF0 = tauNMSimplexInit.createTexture2D("tauNMXiF0", [tauMaxVeces, tauMaxVeces * 9], TexExamples.TauFloatTex, null, ["NEAREST", "NEAREST", "CLAMP", "CLAMP"], "TexUnit4");
    tauNMXiF0.__backupVarName = "tauNMXiF0";
    tauNMXiF0.__backupUniformName = "tauNMXiF0";
    tauNMXiF0.__backupProgram = tauNMSimplexInit?.ID ?? tauNMSimplexInit?.fragPath ?? "tauNMSimplexInit";
    var tauNMXiS0 = tauNMSimplexInit.createTexture2D("tauNMXiS0", [tauMaxVeces, tauMaxVeces * 9], TexExamples.TauFloatTex, null, ["NEAREST", "NEAREST", "CLAMP", "CLAMP"], "TexUnit5");
    tauNMXiS0.__backupVarName = "tauNMXiS0";
    tauNMXiS0.__backupUniformName = "tauNMXiS0";
    tauNMXiS0.__backupProgram = tauNMSimplexInit?.ID ?? tauNMSimplexInit?.fragPath ?? "tauNMSimplexInit";
    var tauNMMeta0 = tauNMSimplexInit.createTexture2D("tauNMMeta0", [tauMaxVeces, tauMaxVeces * 9], TexExamples.TauFloatTex, null, ["NEAREST", "NEAREST", "CLAMP", "CLAMP"], "TexUnit6");
    tauNMMeta0.__backupVarName = "tauNMMeta0";
    tauNMMeta0.__backupUniformName = "tauNMMeta0";
    tauNMMeta0.__backupProgram = tauNMSimplexInit?.ID ?? tauNMSimplexInit?.fragPath ?? "tauNMSimplexInit";
    var tauNMXiF1 = tauNMSimplexInit.createTexture2D("tauNMXiF1", [tauMaxVeces, tauMaxVeces * 9], TexExamples.TauFloatTex, null, ["NEAREST", "NEAREST", "CLAMP", "CLAMP"], "TexUnit7");
    tauNMXiF1.__backupVarName = "tauNMXiF1";
    tauNMXiF1.__backupUniformName = "tauNMXiF1";
    tauNMXiF1.__backupProgram = tauNMSimplexInit?.ID ?? tauNMSimplexInit?.fragPath ?? "tauNMSimplexInit";
    var tauNMXiS1 = tauNMSimplexInit.createTexture2D("tauNMXiS1", [tauMaxVeces, tauMaxVeces * 9], TexExamples.TauFloatTex, null, ["NEAREST", "NEAREST", "CLAMP", "CLAMP"], "TexUnit8");
    tauNMXiS1.__backupVarName = "tauNMXiS1";
    tauNMXiS1.__backupUniformName = "tauNMXiS1";
    tauNMXiS1.__backupProgram = tauNMSimplexInit?.ID ?? tauNMSimplexInit?.fragPath ?? "tauNMSimplexInit";
    var tauNMMeta1 = tauNMSimplexInit.createTexture2D("tauNMMeta1", [tauMaxVeces, tauMaxVeces * 9], TexExamples.TauFloatTex, null, ["NEAREST", "NEAREST", "CLAMP", "CLAMP"], "TexUnit9");
    tauNMMeta1.__backupVarName = "tauNMMeta1";
    tauNMMeta1.__backupUniformName = "tauNMMeta1";
    tauNMMeta1.__backupProgram = tauNMSimplexInit?.ID ?? tauNMSimplexInit?.fragPath ?? "tauNMSimplexInit";
    var tauNMCost = tauNMSimplexInit.createTexture2D("tauNMCost", [tauMaxVeces, tauMaxVeces * 9], TexExamples.TauFloatTex, null, ["NEAREST", "NEAREST", "CLAMP", "CLAMP"], "TexUnit11");
    tauNMCost.__backupVarName = "tauNMCost";
    tauNMCost.__backupUniformName = "tauNMCost";
    tauNMCost.__backupProgram = tauNMSimplexInit?.ID ?? tauNMSimplexInit?.fragPath ?? "tauNMSimplexInit";
    ...
    var tauAdjFieldsTex = tauAdjFields.createTexture2D("tauAdjFields", [nBins, tauAdjTauBatch * tauMaxVeces * 9], TexExamples.TauFloatTex, null, ["NEAREST", "NEAREST", "CLAMP", "CLAMP"], "TexUnit28");
    tauAdjFieldsTex.__backupVarName = "tauAdjFieldsTex";
    tauAdjFieldsTex.__backupUniformName = "tauAdjFields";
    tauAdjFieldsTex.__backupProgram = tauAdjFields?.ID ?? tauAdjFields?.fragPath ?? "tauAdjFields";
    ...
    var tauAdjDiffOpsTex = tauAdjDiffOps.createTexture2D("tauAdjDiffOps", [nBins * nBins, tauAdjTauBatch * tauMaxVeces * 9], TexExamples.TauFloatTex, null, ["NEAREST", "NEAREST", "CLAMP", "CLAMP"], "TexUnit29");
    tauAdjDiffOpsTex.__backupVarName = "tauAdjDiffOpsTex";
    tauAdjDiffOpsTex.__backupUniformName = "tauAdjDiffOps";
    tauAdjDiffOpsTex.__backupProgram = tauAdjDiffOps?.ID ?? tauAdjDiffOps?.fragPath ?? "tauAdjDiffOps";
    ...
    var tauAdjOperatorTex = tauAdjOperator.createTexture2D("tauAdjOperator", [nBins * nBins, tauAdjTauBatch * tauMaxVeces * 9], TexExamples.TauFloatTex, null, ["NEAREST", "NEAREST", "CLAMP", "CLAMP"], "TexUnit30");
    tauAdjOperatorTex.__backupVarName = "tauAdjOperatorTex";
    tauAdjOperatorTex.__backupUniformName = "tauAdjOperator";
    tauAdjOperatorTex.__backupProgram = tauAdjOperator?.ID ?? tauAdjOperator?.fragPath ?? "tauAdjOperator";
    ...
    var tauAdjExpTex = tauAdjExp.createTexture2D("tauAdjExp", [nBins, tauAdjTauBatch * tauMaxVeces * 9], TexExamples.TauFloatTex, null, ["NEAREST", "NEAREST", "CLAMP", "CLAMP"], "TexUnit31");
    tauAdjExpTex.__backupVarName = "tauAdjExpTex";
    tauAdjExpTex.__backupUniformName = "tauAdjExp";
    tauAdjExpTex.__backupProgram = tauAdjExp?.ID ?? tauAdjExp?.fragPath ?? "tauAdjExp";
    ...
    var tauSteadyFPTex = tauSteadyFP.createTexture2D("tauSteadyFP", [nBins, tauAdjTauBatch * tauMaxVeces * 9], TexExamples.TauFloatTex, null, ["NEAREST", "NEAREST", "CLAMP", "CLAMP"], "TexUnit27");
    tauSteadyFPTex.__backupVarName = "tauSteadyFPTex";
    tauSteadyFPTex.__backupUniformName = "tauSteadyFP";
    tauSteadyFPTex.__backupProgram = tauSteadyFP?.ID ?? tauSteadyFP?.fragPath ?? "tauSteadyFP";
    ...
    var tauKrylov0Tex = tauKrylovInit.createTexture2D("tauKrylov0", [nBins, tauAdjTauBatch * tauMaxVeces * 9], TexExamples.TauFloatTex, null, ["NEAREST", "NEAREST", "CLAMP", "CLAMP"], "TexUnit23");
    tauKrylov0Tex.__backupVarName = "tauKrylov0Tex";
    tauKrylov0Tex.__backupUniformName = "tauKrylov0";
    tauKrylov0Tex.__backupProgram = tauKrylovInit?.ID ?? tauKrylovInit?.fragPath ?? "tauKrylovInit";
    ...
    var tauArnoldiCoeffTex = tauArnoldiCoeff.createTexture2D("tauArnoldiCoeff", [14, tauAdjTauBatch * tauMaxVeces * 9], TexExamples.TauFloatTex, null, ["NEAREST", "NEAREST", "CLAMP", "CLAMP"], "TexUnit22");
    ...
    var tauStatsTex = tauStats.createTexture2D("tauStats", [1, 1], TexExamples.TauFloatTex, null, ["NEAREST", "NEAREST", "CLAMP", "CLAMP"], "TexUnit21");
    tauStatsTex.__backupVarName = "tauStatsTex";
    tauStatsTex.__backupUniformName = "tauStats";
    tauStatsTex.__backupProgram = tauStats?.ID ?? tauStats?.fragPath ?? "tauStats";
    ...
    var tauBestTex = tauBest.createTexture2D("tauBest", [1, 1], TexExamples.TauFloatTex, null, ["NEAREST", "NEAREST", "CLAMP", "CLAMP"], "TexUnit17");
    tauBestTex.__backupVarName = "tauBestTex";
    tauBestTex.__backupUniformName = "tauBest";
    tauBestTex.__backupProgram = tauBest?.ID ?? tauBest?.fragPath ?? "tauBest";
    ...
    var tauSindyTex = tauSindy.createTexture2D("tauSindy", [nBins, 1], TexExamples.TauFloatTex, null, ["NEAREST", "NEAREST", "CLAMP", "CLAMP"], "TexUnit6");
    tauSindyTex.__backupVarName = "tauSindyTex";
    tauSindyTex.__backupUniformName = "tauSindy";
    tauSindyTex.__backupProgram = tauSindy?.ID ?? tauSindy?.fragPath ?? "tauSindy";
    var tauSindyInitTex = tauSindy.createTexture2D("tauSindyInit", [nBins, 1], TexExamples.TauFloatTex, null, ["NEAREST", "NEAREST", "CLAMP", "CLAMP"], "TexUnit7");
    tauSindyInitTex.__backupVarName = "tauSindyInitTex";
    tauSindyInitTex.__backupUniformName = "tauSindyInit";
    tauSindyInitTex.__backupProgram = tauSindy?.ID ?? tauSindy?.fragPath ?? "tauSindy";
    var tauSindyTau1RefTex = tauSindy.createTexture2D("tauSindyTau1Ref", [nBins, 1], TexExamples.TauFloatTex, null, ["NEAREST", "NEAREST", "CLAMP", "CLAMP"], "TexUnit8");
    tauSindyTau1RefTex.__backupVarName = "tauSindyTau1RefTex";
    tauSindyTau1RefTex.__backupUniformName = "tauSindyTau1Ref";
    tauSindyTau1RefTex.__backupProgram = tauSindy?.ID ?? tauSindy?.fragPath ?? "tauSindy";
    ...
    var __globalBlockFn_1 = async (dt) => {
        ...
        if (c2DrawLogFrames > 0) {
            ...
            console.log("C2 drawTauPanel", (bestTau), (bestSubseq), (gl.getParameter(gl.FRAMEBUFFER_BINDING)), (showTauCurves), (!!(window.simDataX)), (!!(window.simDataY)), (~~(window.simStampX || 0)), (~~(window.simStampY || 0)));
