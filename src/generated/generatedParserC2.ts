    ...
    while(tauAFPOptPass<tauAFPOptMaxPasses && !tauAFPOptDone){
        ...
        while(tauNMInner<tauAFPOptChunk){
            ...
            while(tauAdjX0<tauMaxVeces){
                ...
                tauAdjExp.use?.();
                tauAdjExp.uNum("tauExpTerms", false, false).set((Math.max(1, Math.min(2, ~~tauExpTerms))));
                tauAdjExp.bindTexName2TexUnit("tauAdjFields", "TexUnit28");
                tauAdjExp.bindTexName2TexUnit("tauAdjOperator", "TexUnit30");
                tauAdjFieldsTex.bind("TexUnit28");
                ...
                tauAdjCost.bindTexName2TexUnit("tauSteadyFP", "TexUnit29");
