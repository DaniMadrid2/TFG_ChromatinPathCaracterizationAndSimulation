...
var __globalBlockFn_1 = async (dt)=>{ // drawPCASetup
    if(showPCA){
...
var __globalBlockFn_2 = async (dt)=>{ // drawPCAAxes
    // <block drawPCAAxes>
...
var __globalBlockFn_3 = async (dt)=>{ // drawCromatin
    // <block drawCromatin>
    for (let n_cromatin = 0; n_cromatin <= (nCromatins-1); n_cromatin++) {
        gl.bindFramebuffer(gl.FRAMEBUFFER, null);
        await d.use?.();
...
var __globalBlockFn_4 = async (dt)=>{ // drawStartMarker
